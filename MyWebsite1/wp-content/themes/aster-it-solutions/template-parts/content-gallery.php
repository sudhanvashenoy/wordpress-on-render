...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $aster_it_solutions_post_id = get_the_ID(); // Add this line to get the post ID
		    $aster_it_solutions__gallery_shortcode = get_post_gallery();

		    if (!empty($aster_it_solutions__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($aster_it_solutions__gallery_shortcode) . '</div>';
		    }
		?>
