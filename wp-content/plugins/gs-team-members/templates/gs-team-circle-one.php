				...
				<div class="single-member--wrapper" itemscope itemtype="http://schema.org/Organization">
					...
					<div class="single-member">
						...
						<div class="gs_team_image__wrapper">
							<?php member_thumbnail_custom( $gs_member_thumbnail_sizes, $id, $gs_member_name_is_linked == 'on', $gs_member_link_type, true ); ?>
							<?php 
								if( $gs_member_name_is_linked == 'off' ){
									echo '<div class="gs_team_image__overlay"></div>';
								} 
							?>
						</div>
